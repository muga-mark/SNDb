...
import {
  SET_PAGE_MOVIES_POPULAR,
  SET_PAGE_MOVIES_UPCOMING,
  SET_PAGE_MOVIES_TOPRATED,
  SET_PAGE_TV_AIRINGTODAY,
  SET_PAGE_TV_ONTHEAIR,
  SET_PAGE_TV_POPULAR,
  SET_PAGE_TV_TOPRATED,
} from "./actions/setPageNo";
import {
  SET_SORTEDBY_MOVIES_POPULAR,
  SET_SORTEDBY_MOVIES_TOPRATED,
  SET_SORTEDBY_TV_POPULAR,
  SET_SORTEDBY_TV_TOPRATED,
} from "./actions/setSortBy";
import {
  SET_SEARCH,
  SET_PAGE_SEARCH,
  SET_SEARCH_RESULT,
} from "./actions/setSearch";
...
function Home({
  ...
  tvPopularLoading,
  tvTopRatedLoading,
  setMoviesPopularLoading,
  setMoviesUpcomingLoading,
  setMoviesTopRatedLoading,
  setTVAiringTodayLoading,
  setTVOnTheAirLoading,
  setTVPopularLoading,
  setTVTopRatedLoading,
  setSearchLoading,
}) {
  ...
  const [
    {
      moviesPopular,
      pageMoviesPopular,
      sortedByMoviesPopular,
      moviesUpcoming,
      pageMoviesUpcoming,
      moviesTopRated,
      pageMoviesTopRated,
      sortedByMoviesTopRated,
      tvAiringToday,
      pageTVAiringToday,
      tvOnTheAir,
      pageTVOnTheAir,
